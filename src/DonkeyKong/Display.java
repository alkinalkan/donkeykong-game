...
public class Display {
	...
	private void createDisplay() {
		...
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // çarpý ile oyun kapatma
		frame.setResizable(false);
		frame.setLocationRelativeTo(null); // Oyunu ortada baþlatna
		...
		frame.add(canvas);
		frame.pack(); // Komut almama ihtimalini sýfýrlar
