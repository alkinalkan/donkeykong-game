...
public class Mario extends Entity {
	...
	public boolean sýnýrdamý = false;
	public boolean isJumping;
	public static boolean canjump = false;
	public boolean falling = false;
	public double gravity = 1.0;
	public static boolean bastý = false;
	public int jc = 1;
	// Levels positions
	...
	// Animation check
	public boolean sað, sol, sabit;

	public boolean sabitdur = true;
	// Animations
	public static BufferedImage[] mario_right;
	public static BufferedImage[] mario_left;
	public static BufferedImage[] marioS;
	public static BufferedImage[] duransol;
	public static BufferedImage[] duransaÄŸ;
	...
	public Mario(Game game, Barrel barrel, float x, float y, int height, int width) {
		...
		duransol = new BufferedImage[1];
		duransaÄŸ = new BufferedImage[1];
	...
	public void tick() {
		...
		// Doruk
			...
			if (!bastý && isCollidingLadder == false) {
				falling = true;
				fall();
